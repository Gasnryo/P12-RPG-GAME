...
void setup() {
  ...
  addSpeedButton = new Button("+", 50, width*0.3, height*0.5, 100, 100, yellow, black);
  restartButton = new Button("RESET", width/2, height*0.8, 200, 100, red, black);
  ...
  manDown = new AnimatedGIF(6, 10, "man/down/sprite_", ".png");
  manLeft = new AnimatedGIF(2, 10, "man/left/sprite_", ".png");
  manRight = new AnimatedGIF(2, 10, "man/right/sprite_", ".png");
